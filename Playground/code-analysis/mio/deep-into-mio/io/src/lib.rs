...
use metrics::{register_queue_with_group, Queue};
use mio::{deprecated::NotifyError, Poll, Token};
use std::{cell::Cell, error, fmt, sync::Arc};
...
lazy_static::lazy_static! {
    static ref NET_IO_WORKER_QUEUE: Arc<dyn Queue> =
        register_queue_with_group("io", "io_worker_queue");
    static ref NET_SOCKET_WORKER_QUEUE: Arc<dyn Queue> =
        register_queue_with_group("io", "socket_worker_queue");
}
